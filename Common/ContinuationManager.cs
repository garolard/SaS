...
namespace SaS.Common
{
    public class ContinuationManager
    {
        ...
        internal void Continue(IContinuationActivatedEventArgs args, bool useViewModelForContinuation)
        {
            Continue(args, Window.Current.Content as Frame, useViewModelForContinuation);
        }
        ...
        internal void Continue(IContinuationActivatedEventArgs args, Frame rootFrame, bool useViewModelForContinuation = false)
        {
            if (args == null)
            ...
            switch (args.Kind)
            {
                case ActivationKind.PickFileContinuation:
                    if (useViewModelForContinuation)
                    {
                        var fileOpenPickerPage = rootFrame.Content as Page;
                        var fileOpenPickerViewModel = fileOpenPickerPage.DataContext as IFileOpenPickerContinuable;
                ...
                case ActivationKind.PickSaveFileContinuation:
                    if (useViewModelForContinuation)
                    {
                        var fileSavePickerPage = rootFrame.Content as Page;
                        var fileSavePickerViewModel = fileSavePickerPage.DataContext as IFileSavePickerContinuable;
                ...
                case ActivationKind.PickFolderContinuation:
                    if (useViewModelForContinuation)
                    {
                        var folderPickerPage = rootFrame.Content as Page;
                        var folderPickerViewModel = folderPickerPage.DataContext as IFolderPickerContinuable;
                ...
                case ActivationKind.WebAuthenticationBrokerContinuation:
                    if (useViewModelForContinuation)
                    {
                        var wabPage = rootFrame.Content as Page;
                        var wabViewModel = wabPage.DataContext as IWebAuthenticationContinuable;
